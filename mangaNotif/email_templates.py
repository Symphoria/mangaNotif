                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:390px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-left:18px; padding-bottom:9px; padding-right:18px;">
                            ...
                            Confirm your email to dive into awesomeness.
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
...
<p>We have finished setting up your account. Click on the link given below to confirm your email and activate your account. After clicking on the link, you will be automatically directed to the login page of our website.&nbsp;</p>
